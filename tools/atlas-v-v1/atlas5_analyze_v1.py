...
FAMILIES=[
 {"family":"A5_01_RETURN_AUTOCORR_REGIME","kind":"DIRECTIONAL","control":"CONTROL_OPPOSITE","h":60,"secondary":[30,120]},
 {"family":"A5_02_ROBUST_LOCATION_SHIFT","kind":"DIRECTIONAL","control":"CONTROL_OPPOSITE","h":60,"secondary":[30,120]},
 {"family":"A5_03_TAIL_COUNT_EXHAUSTION","kind":"DIRECTIONAL","control":"CONTROL_CONT","h":60,"secondary":[30,120]},
 {"family":"A5_04_PERMUTATION_ENTROPY","kind":"AMPLITUDE","control":"CONTROL_HIGH_ENTROPY","h":60,"secondary":[120]},
 {"family":"A5_05_VOL_CLUSTER_AUTOCORR","kind":"AMPLITUDE","control":"CONTROL_NEUTRAL_AUTOCORR","h":60,"secondary":[120]},
 {"family":"A5_06_RANGE_RETENTION","kind":"AMPLITUDE","control":"CONTROL_HIGH_RETENTION","h":60,"secondary":[120]},
]
...
def main():
    ...
    out=args.output_dir/"atlas5_analysis.json"; out.write_text(json.dumps(report,indent=2,sort_keys=True,allow_nan=False)+"\n",encoding="utf-8")
    print("=== GUARDIAN ATLAS V V1 ==="); print(f"INPUT ROWS: {total}"); print("2023+ ACCESSED: FALSE"); print("2026 ACCESSED: FALSE")
