...
CANDIDATE_IDS = [
    ...
    "BE1p5_TP2_SL2_H60",
    "BE1_TP2p5_SL2_H60",
    "P50_1R_BE_TP2_SL2_H60",
    "P50_1p5R_BE_TP2p5_SL2_H60",
]
...
def main():
    ...
    with args.input.open(newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            ...
            z = {
                ...
                "partial_taken": truthy(row.get("partial_taken")),
                "be_activated": truthy(row.get("be_activated")),
            }
            raw[cand][var].append(z)
    ...
    for i, cand in enumerate(CANDIDATE_IDS):
        ...
        dt = daily_delta(sig, ctl, "r_cost_010", SEED + i * 100 + 1)
        prelim[cand] = (st, dt)
    ...
    report = {
        ...
        "multiple_testing": {
            "signal_tests": "BH across 12 candidate daily-mean sign-flip tests",
            "delta_tests": "BH across 12 signal-minus-control daily-delta sign-flip tests",
        },
        "gate": GATE,
        "selection_rule": (
    ...
    out = args.output_dir / "as2_execution_lab_ii_analysis.json"
    out.write_text(
        json.dumps(report, indent=2, sort_keys=True, allow_nan=False) + "\n",
        encoding="utf-8",
    )

    print("=== AS2 EXECUTION LAB II V1 ===")
